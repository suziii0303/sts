...
<body>
	...
	<div>
		...
		<input type="text" id="id_message" /> <input type="button"
			id="id_send" value="떤쏭"> <input type="button" id="id_exit"
			value="나갈령">
	</div>
</body>
<script>
// 스크립트 변수는 페이지가 바뀌거나, 새로 로딩되면서 사라져 버림 
// 이런걸 잘 처리 해야 함, F.E (Front Engineer)
// 개념(단순한데 자꾸 그냥 넘기려 함)
      ...
      connect();
      function connect() {
         webSocket = new WebSocket("ws://192.168.142.3:8080/merong/ws-chat"); // End Point
